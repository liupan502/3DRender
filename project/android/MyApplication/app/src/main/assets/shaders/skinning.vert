...
void skin_pos(int mat_idx, float blend_weight) {
...
vec4 get_pos() {
    ...
    skin_pos(a_blend_indices.x, a_blend_weight.x);
    skin_pos(a_blend_indices.y, a_blend_weight.y);
    skin_pos(a_blend_indices.z, a_blend_weight.z);
    skin_pos(a_blend_indices.w, a_blend_weight.w);
